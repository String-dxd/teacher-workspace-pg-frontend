...
export const consentFormsList: ApiConsentFormSummary[] = [
  {
    ...
    status: 'OPEN',
    toParentsOf: ['4A', '4B'],
    respondedMetrics: { respondedPerStudent: 0.7, totalStudents: 10 },
...
export const consentFormDetail: ApiConsentFormDetail = {
        ...
        content: [
          {
            ...
            content: [
              {
                type: 'paragraph',
                content: [{ type: 'text', text: 'Date: Wednesday, 25 June 2026' }],
              },
            ],
          },
          {
  ...
  customQuestions: [
    { questionId: 1, type: 'FREE_TEXT', text: 'Does your child have any food allergies?' },
    {
      questionId: 2,
      type: 'MCQ',
      text: 'Preferred lunch option',
      options: ['Chicken Rice', 'Nasi Lemak', 'Vegetarian'],
    },
  ],
  staffOwners: [
  ...
  consentFormRecipients: [
    ...
    },
    {
      studentId: 3004,
      reply: 'YES',
      replyDate: '2026-06-11T08:15:00+08:00',
      replyByParent: 'Mrs Tan',
      parentType: 'Mother',
      contactNumber: '81112222',
      remarks: null,
      isIndividual: false,
      onBoardedCategory: 'ONBOARDED',
      customQuestionReply: [
    ...
    },
    {
      studentId: 3005,
      reply: 'YES',
      replyDate: '2026-06-10T18:45:00+08:00',
      replyByParent: 'Mr Kumar',
      parentType: 'Father',
      contactNumber: '92223333',
      remarks: null,
      isIndividual: false,
      onBoardedCategory: 'ONBOARDED',
      customQuestionReply: [
    ...
    },
    {
      studentId: 3007,
      reply: 'NO',
      replyDate: '2026-06-11T10:00:00+08:00',
      replyByParent: 'Mrs Lim',
      parentType: 'Mother',
      contactNumber: '93334444',
    ...
    },
    {
      studentId: 3008,
      reply: 'YES',
      replyDate: '2026-06-10T20:30:00+08:00',
      replyByParent: 'Mdm Wong',
      parentType: 'Guardian',
      contactNumber: '94445555',
      remarks: null,
      isIndividual: false,
      onBoardedCategory: 'ONBOARDED',
    ...
    },
    {
      studentId: 3010,
      reply: 'YES',
      replyDate: '2026-06-11T07:00:00+08:00',
      replyByParent: 'Mr Ong',
      parentType: 'Father',
      contactNumber: '95556666',
      remarks: null,
      isIndividual: false,
      onBoardedCategory: 'ONBOARDED',
      customQuestionReply: [
  ...
  consentFormHistory: [
    {
      historyId: 1,
      action: 'CREATED',
      actionAt: '2026-06-08T16:00:00+08:00',
      actionBy: 'Mr Lim Kah Hoe',
    },
    {
      historyId: 2,
      action: 'POSTED',
      actionAt: '2026-06-09T09:00:00+08:00',
      actionBy: 'Mr Lim Kah Hoe',
    },
  ],
  targets: [
